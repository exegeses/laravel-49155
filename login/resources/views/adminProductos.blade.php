<x-app-layout>
    ...
    <div class="py-12">
        ...
        @foreach( $productos as $producto )
                    ...
                    <div class="border-b border-gray-100 p-3 flex items-center justify-center">
                        <img src="/productos/{{ $producto->prdImagen }}" class="shadow rounded max-w-full h-auto align-middle border-none">
                    </div>
                    <div class="border-b border-gray-100 p-3 flex items-center justify-center">
                                                <span class="w-1/4 mx-2">
                            <a href="/producto/edit/{{ 'idProducto' }}" class="text-yellow-600 hover:text-yellow-500
                                        bg-gray-50 hover:bg-white px-5 py-1
                                        border border-gray-300 rounded
                                        ">Modificar</a>
                        </span>
